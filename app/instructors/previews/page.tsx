...
const C = {
  ...
  teal: "#3DB8AF",
  violet: "#9B7FD4",
  violetLight: "rgba(155,127,212,0.08)",
  gold: "#C9983F",
...
const TERMS = `SOUND SPACE PREVIEWS — INSTRUCTOR AGREEMENT
Sound Healing Products LLC d/b/a The Sound Space
Sutton, Alaska

By signing this agreement, you make a binding commitment as a confirmed facilitator at a Sound Space Previews event.

──────────────────────────────────────────────

1. COMMITMENT TO YOUR SESSION
Your session is on the schedule. The community is counting on you. Once your session is confirmed and published, you are expected to show up and deliver it. This is not a casual arrangement — it is a commitment to the people who have planned their time around your offering.

Cancellation of your session is unacceptable. If you cannot attend for any reason, you must notify event management in writing at support@thesoundspace.us as soon as possible. Cancellation without adequate notice and a legitimate reason is a violation of this agreement and may affect your eligibility for future Sound Space events.

2. SCHEDULE CONFLICTS
Upon signing this agreement, you agree to immediately review the full event schedule and notify management of any conflicts within 48 hours. Session times are accommodated on a best-effort basis before the schedule is finalized. No changes to the published schedule will be made within 14 days of the event.

3. ATTENDANCE & PUNCTUALITY
You agree to arrive no later than 45 minutes before your scheduled session. Late arrival without prior communication is not acceptable. If a genuine emergency prevents your attendance, contact management immediately at support@thesoundspace.us so that arrangements can be made for your participants.

4. FACILITATOR EXCHANGE
As a confirmed Sound Space Previews facilitator, you receive the following in exchange for your offering:

  • 1 full event pass (access to the full Previews gathering)
  • 1 guest pass
  • Promotion across Sound Space marketing channels
...
If a specific compensation arrangement was proposed and approved by management prior to signing, those terms are documented separately. This agreement alone does not create a compensation obligation beyond the facilitator exchange above.

6. COMPENSATION REQUESTS
If you require a specific compensation arrangement beyond the facilitator exchange, submit your request in writing to support@thesoundspace.us before signing. Requests submitted after signing will not be considered. Our team reviews proposals and determines whether they can be incorporated into our programming and budget.

7. CONTENT & CONDUCT STANDARDS
You agree to deliver the session described in your application, as approved by event management. Material deviations from your approved offering require prior written approval. Sessions that include content deemed harmful, unsafe, or inconsistent with The Sound Space's values may be stopped.
...
The Sound Space offers facilitators the opportunity to be featured as a brand partner. Brand partners receive enhanced promotion including featured placement on the website, extended social media features, and co-branded marketing content. If you are interested, indicate your interest on this form and our team will follow up.
...
Events take place outdoors in Alaska. You acknowledge that participation involves inherent risks including weather, terrain, and wildlife. You are responsible for your own safety and the safety of your session space and equipment.

11. INDEMNIFICATION
You agree to indemnify, defend, and hold harmless Sound Healing Products LLC, its organizers, volunteers, staff, and partners from any and all claims, damages, losses, or expenses arising out of your participation, your session content, or any act or omission on your part or the part of your guests.
...
export default function InstructorPreviewsPage() {
      ...
      <main style={{ minHeight: "100vh", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem" }}>
        <div style={{ maxWidth: 520, width: "100%", textAlign: "center" }}>
          ...
          <p style={{ color: C.muted, lineHeight: 1.7, marginBottom: "0.75rem" }}>
            Thank you, {fullName.split(" ")[0]}. Your signed instructor agreement for Sound Space Previews has been received.
          </p>
          <p style={{ color: C.muted, lineHeight: 1.7, marginBottom: "2rem" }}>
            A confirmation will be sent to <strong>{email}</strong>. Please review the event schedule and reach out to{" "}
          ...
          <p style={{ color: C.forest, fontWeight: 700, fontSize: "0.95rem", marginBottom: "2rem", letterSpacing: "0.04em" }}>
            Commitment is the standard. We look forward to holding space together.
          </p>
    ...
    <main style={{ minHeight: "100vh", background: C.bg, padding: "0 0 5rem" }}>
      ...
      <div style={{ background: C.charcoal, color: "#fff", padding: "3.5rem 1.5rem 3rem", textAlign: "center" }}>
        <p style={{ color: "rgba(255,255,255,0.5)", fontSize: "0.78rem", letterSpacing: "0.14em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
          Facilitator Agreement · Sound Space Previews
        </p>
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(1.9rem,5vw,2.8rem)", fontWeight: 600, marginBottom: "0.6rem" }}>
          Previews Instructor Agreement
        </h1>
        <p style={{ color: "rgba(255,255,255,0.65)", fontSize: "1rem", maxWidth: 560, margin: "0 auto", lineHeight: 1.6 }}>
          The Sound Space · Sutton, Alaska
        </p>
        <div style={{ marginTop: "1.5rem", display: "inline-block", background: "rgba(155,127,212,0.18)", borderRadius: 8, padding: "0.55rem 1.1rem" }}>
          <p style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.85rem", margin: 0, fontStyle: "italic" }}>
      ...
      <div style={{ maxWidth: 700, margin: "0 auto", padding: "2.5rem 1.25rem 0" }}>
        <form onSubmit={handleSubmit}>
          ...
          <p style={{ color: C.muted, fontSize: "0.84rem", marginBottom: "1.25rem" }}>
            This agreement is for confirmed Previews facilitators only. Contact{" "}
            <a href="mailto:support@thesoundspace.us" style={{ color: C.teal }}>support@thesoundspace.us</a>{" "}
          ...
          <div style={{ display: "grid", gap: "0.85rem", marginBottom: "2rem" }}>
            ...
            <div>
              ...
              <input style={inputStyle} placeholder="e.g. Sound Journey, Aerial Silks Workshop" value={sessionTitle} onChange={e => setSessionTitle(e.target.value)} />
            </div>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.85rem" }}>
              <div>
            ...
            <div>
              ...
              <textarea rows={3} style={{ ...inputStyle, resize: "vertical" }} placeholder="2–3 sentences we can use in promotion." value={bio} onChange={e => setBio(e.target.value)} />
            </div>
          </div>
          ...
          <div style={{ background: C.card, border: `1px solid ${C.border}`, borderRadius: 12, padding: "1.4rem 1.5rem", marginBottom: "1rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: "0.87rem", marginBottom: "0.85rem", lineHeight: 1.6 }}>
              Sound Space Previews instructors participate as <strong style={{ color: C.charcoal }}>volunteer facilitators</strong> and receive the following in exchange for their offering:
            </p>
            <ul style={{ margin: 0, padding: 0, listStyle: "none", display: "grid", gap: "0.4rem" }}>
              {[
                ["1 full event pass", "Access to the complete Previews gathering"],
                ["1 guest pass", "Bring someone to share the experience"],
                ["Promotion across all channels", "Sound Space website, email, and social media"],
              ].map(([bold, rest]) => (
          ...
          <div style={{ marginBottom: "2rem" }}>
            <CheckRow checked={checkVolunteer} onChange={setCheckVolunteer}>
              I understand that facilitator positions are offered as a <strong>volunteer exchange</strong> and not paid employment. The benefits listed above are my compensation for this event.
            </CheckRow>
          </div>
          ...
          <div style={{ background: "#f9f7f2", border: `1px solid ${C.border}`, borderRadius: 10, padding: "1.1rem 1.3rem", marginBottom: "1.5rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: "0.83rem", lineHeight: 1.65, margin: 0 }}>
              If you require a specific compensation arrangement, submit your request in writing before signing.
          ...
          <div style={{ marginBottom: "2rem" }}>
            ...
            <p style={{ color: C.muted, fontSize: "0.84rem", lineHeight: 1.65, marginBottom: "0.85rem" }}>
              Facilitators may be featured as brand partners with enhanced promotion — featured website placement, extended social features, and co-branded content.
            </p>
          ...
          <h2 style={sectionHead}>Agreement Terms</h2>
          <p style={{ color: C.muted, fontSize: "0.84rem", marginBottom: "0.75rem" }}>
            Please read the full agreement. Scroll to the bottom to unlock the checkboxes below.
          </p>
          ...
          <div style={{ display: "grid", gap: "0.65rem", marginBottom: "2rem", opacity: termsRead ? 1 : 0.45, pointerEvents: termsRead ? "auto" : "none" }}>
            <CheckRow checked={checkCommit} onChange={setCheckCommit}>
              I commit to showing up and delivering my session as scheduled. I understand that <strong>cancellation of my session is unacceptable</strong> and a violation of this agreement. If an emergency arises, I will notify management immediately in writing.
            </CheckRow>
            <CheckRow checked={checkSchedule} onChange={setCheckSchedule}>
              I agree to review the full event schedule upon signing and notify management of any conflicts within 48 hours. I understand that no schedule changes will be made within 14 days of the event.
            </CheckRow>
          ...
          >
            {submitting ? "Submitting Agreement…" : "Sign & Submit Previews Agreement"}
          </button>
