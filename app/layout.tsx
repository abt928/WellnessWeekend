...
const metaPixelId =
  rawMetaPixelId && /^\d{8,20}$/.test(rawMetaPixelId)
    ? rawMetaPixelId
    : null;
...
export const metadata: Metadata = {
  ...
  description:
    "Three days of healing arts, ecstatic movement, live music, and lakeside ceremony under Alaska's midnight sun. August 7-9, 2026 in Sutton.",
  keywords: [
    ...
    "Alaska music festival",
    "Alaska wellness festival",
    "breathwork retreat",
    "healing arts Alaska",
    "Lions Gate portal",
  ],
  ...
  openGraph: {
    title: "Wellness Weekend · Alaska Healing Arts Festival",
    description:
      "A real three-day gathering of sound, movement, music, and lakeside ceremony. August 7-9, 2026 in Sutton, Alaska.",
    type: "website",
    ...
    images: [
      {
        url: "/images/gallery/2025-08-09_Festival_Wellness_Group-Circle-Arms-Raised.jpg",
        width: 1200,
        height: 675,
        alt: "Guests moving together at Wellness Weekend in Sutton, Alaska",
      },
    ],
  },
  twitter: {
    ...
    title: "Wellness Weekend · Alaska Healing Arts Festival",
    description:
      "Three days of healing arts, ecstatic movement, live music, and lakeside ceremony. August 7-9, 2026 in Sutton, Alaska.",
    images: [
      "/images/gallery/2025-08-09_Festival_Wellness_Group-Circle-Arms-Raised.jpg",
    ],
  },
  other: {
    "theme-color": "#0f2017",
