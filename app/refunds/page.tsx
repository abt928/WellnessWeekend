...
export const metadata: Metadata = {
  ...
  description: "Our ticket refund and event cancellation policy for Wellness Weekend.",
};
      ...
      <main className="legal-page">
        <div className="legal-container">
          <header className="legal-header">
            ...
            <h1 className="legal-title" style={{ fontFamily: "var(--font-display)" }}>
              Refund policy.
            </h1>
          ...
          <article className="legal-body">
            <section className="legal-section">
              ...
              <h3>No Refunds</h3>
              <p>
                <strong>All sales are final. No refunds will be issued under any circumstances.</strong>
              </p>
              <p>
                Tickets are transferable to another attendee at no additional charge.
                Contact us to arrange a transfer prior to the event.
              </p>
              ...
              <p>
                ...
                circumstances, ticket holders will receive the option to transfer
                their purchase to the following year&rsquo;s event.
              </p>
            </section>
            ...
            <section className="legal-section">
              ...
              <div className="legal-contact">
                <p><strong>Sound Healing Products LLC</strong></p>
                <p>d/b/a Wellness Weekend</p>
                <p>Sutton, Alaska</p>
                <p>Email: <a href="mailto:support@thesoundspace.us">support@thesoundspace.us</a></p>
                <p>Phone: <a href="tel:+19076004390">+1 (907) 600-4390</a></p>
              </div>
            </section>
          </article>
