...
export const scheduleDays: ScheduleDay[] = [
  {
    ...
    events: [
      ...
      },
      {
        ...
        detail: "A 2-hour immersion in guided meditation and multidimensional visualization — release limiting energetic patterns, reconnect with your Higher Self, and set the intention for a transformative weekend.",
        element: "fire", location: "Main Stage",
  ...
  },
  {
    ...
    events: [
      ...
      },
      {
        ...
        detail: "A 2-hour drumming ceremony of courage, sovereignty, and sacred purpose — bring your drum.",
